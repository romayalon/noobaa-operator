...
func TestGroupJoin(t *testing.T) {
	groups := []nbv1.TLSGroup{nbv1.TLSGroupX25519MLKEM768, nbv1.TLSGroupX25519, nbv1.TLSGroupSecp256r1}
	if v := JoinTLSGroups(groups, ":"); v != "X25519MLKEM768:X25519:secp256r1" {
		t.Errorf("expected colon-joined groups, got %q", v)
	}
	var nilSlice []nbv1.TLSGroup
	if v := JoinTLSGroups(nilSlice, ":"); v != "" {
