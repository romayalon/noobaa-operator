...
func NewReconciler(
	...
	r := &Reconciler{
		...
		ServiceVector:             util.KubeObject(bundle.File_deploy_internal_service_vector_yaml).(*corev1.Service),
		...
		RouteVector:               util.KubeObject(bundle.File_deploy_internal_route_vector_yaml).(*routev1.Route),
	...
	r.ServiceVector.Namespace = r.Request.Namespace
	...
	r.RouteVector.Namespace = r.Request.Namespace
	...
	r.RouteVector.Name = r.ServiceVector.Name
	...
	r.RouteVector.Spec.To.Name = r.ServiceVector.Name
...
func (r *Reconciler) CheckAll() {
	...
	util.KubeCheck(r.ServiceVector)
	...
	util.KubeCheckOptional(r.RouteVector)
}
