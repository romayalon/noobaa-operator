...
func (p *Provisioner) DriverCreateBucket(ctx context.Context,
	...
	// ROMY - check how to handle, delete or edit
	// protocol := req.
	// if protocol == nil {
	// 	msg := "Protocol is nil"
	// 	log.Errorf(msg)
...
func (p *Provisioner) DriverGrantBucketAccess(ctx context.Context,
	...
	return &cosi.DriverGrantBucketAccessResponse{
		...
		Credentials: map[string]*cosi.CredentialDetails{
			"keys": &cosi.CredentialDetails{ // ROMY - check that on rook, doesn't feel right
				Secrets: map[string]string{
					"aws_access_key": keys.AccessKey,
					"aws_secret_key": keys.SecretKey,
				},
			},
		},
	}, nil
