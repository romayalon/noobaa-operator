...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DeepArchiveSpec) DeepCopyInto(out *DeepArchiveSpec) {
	*out = *in
	out.Secret = in.Secret
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DeepArchiveSpec.
func (in *DeepArchiveSpec) DeepCopy() *DeepArchiveSpec {
	if in == nil {
		return nil
	}
	out := new(DeepArchiveSpec)
	in.DeepCopyInto(out)
	return out
}
...
func (in *NamespaceStoreSpec) DeepCopyInto(out *NamespaceStoreSpec) {
	*out = *in
	...
	if in.DeepArchive != nil {
		in, out := &in.DeepArchive, &out.DeepArchive
		*out = new(DeepArchiveSpec)
		**out = **in
	}
	return
