              ...
              security:
                ...
                properties:
                  ...
                  tlsConfig:
                    ...
                    properties:
                      ciphers:
                        description: Ciphers is the list of IANA cipher suite names
                          to enable, in preference order.
                        items:
                          description: |-
                      ...
                      groups:
                        description: Groups is the list of key exchange groups to
                          enable, in preference order.
                        items:
                          description: |-
                        ...
                        x-kubernetes-list-type: set
                      version:
                        description: Version specifies the minimum and maximum TLS
                          protocol version.
                        enum:
                        - TLSv1.2
                        - TLSv1.3
                    ...
                    - message: TLS 1.3 ciphers are not valid for TLSv1.2
                      rule: self.version != 'TLSv1.2' || !self.ciphers.exists(c, c
                        in ['TLS_AES_128_GCM_SHA256','TLS_AES_256_GCM_SHA384','TLS_CHACHA20_POLY1305_SHA256'])
                    - message: TLS 1.2 ciphers are not valid for TLSv1.3
                      rule: self.version != 'TLSv1.3' || !self.ciphers.exists(c, c
                        in ['TLS_ECDHE_ECDSA_WITH_AES_128_GCM_SHA256','TLS_ECDHE_ECDSA_WITH_AES_256_GCM_SHA384','TLS_ECDHE_ECDSA_WITH_CHACHA20_POLY1305_SHA256','TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256','TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384','TLS_ECDHE_RSA_WITH_CHACHA20_POLY1305_SHA256'])
                    - message: hybrid post-quantum groups are not valid for TLSv1.2
                      rule: self.version != 'TLSv1.2' || !self.groups.exists(g, g
                        in ['X25519MLKEM768','SecP256r1MLKEM768','SecP384r1MLKEM1024'])
                type: object
              tolerations:
