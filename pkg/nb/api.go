...
type Client interface {
	...
	UpdateBucketClassReplicationAPI(BucketReplicationParams) error
}
...
// UpdateBucketClassReplicationAPI calls bucket_api.update_bucket_class_replication()
func (c *RPCClient) UpdateBucketClassReplicationAPI(params BucketReplicationParams) error {
	req := &RPCMessage{API: "bucket_api", Method: "update_bucket_class_replication", Params: params}
	return c.Call(req, nil)
}
