...
- Archive policy can be added to an existing placement bucket class by updating the CR (or patching it); the operator will propagate the change to all buckets in the class.
  ...
  placementPolicy:
    tiers:
      - backingstores:
          - bs1
  archivePolicy:
    deep_archive_resource: my-da-ns
```
